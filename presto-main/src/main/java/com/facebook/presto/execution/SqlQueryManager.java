        ...
        implements QueryManager
{
    ...
    private static class QueryStarter
    {
        ...
        public QueryStarter(Executor queryExecutor, SqlQueryManagerStats stats, QueryManagerConfig config)
        {
            ...
            this.queryAsyncSemaphore = new AsyncSemaphore<>(config.getMaxConcurrentQueries(), config.getMaxConcurrentQueriesPerUser(), queryExecutor, new QuerySubmitter(queryExecutor, stats, queryQueueSize));
            this.maxQueuedBigQueries = config.getMaxQueuedBigQueries();
            this.bigQueryAsyncSemaphore = new AsyncSemaphore<>(config.getMaxConcurrentBigQueries(), config.getMaxConcurrentQueriesPerUser(), queryExecutor, new QuerySubmitter(queryExecutor, stats, bigQueryQueueSize));
        }

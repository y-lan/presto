...
public class GpdataJobRecordCursor
        implements RecordCursor
{
            ...
            InputSupplier<InputStream> inputStreamSupplier)
    {
        ...
        try {
            this.input = inputStreamSupplier.getInput();
            unpacker = new MessagePack().createUnpacker(input);
            ArrayValue values = unpacker.readValue().asArrayValue();
    ...
    public Slice getSlice(int field)
    {
        ...
        if (value.isArrayValue()) {
            s = value.asArrayValue().toString();
        }
        else if (value.isMapValue()) {
            s = value.asMapValue().toString();
        }
        else {
            s = value.asRawValue().getString();
        }

...
public final class TdjobColumnHandle
        implements ConnectorColumnHandle
{
    ...
    public TdjobColumnHandle(String connectorId, ColumnMetadata columnMetadata)
    {
        this(connectorId, columnMetadata.getName(), columnMetadata.getType(), columnMetadata.getOrdinalPosition());
    }

    @JsonCreator
    public TdjobColumnHandle(
    ...
    public boolean equals(Object obj)
    {
        ...
        TdjobColumnHandle other = (TdjobColumnHandle) obj;

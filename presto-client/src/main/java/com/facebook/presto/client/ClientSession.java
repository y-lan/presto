...
public class ClientSession
{
    ...
    public ClientSession(URI server, String user, String identify, String source, String catalog, String schema, String timeZoneId, Locale locale, Map<String, String> properties,  boolean debug)
    {
